...
struct AlgorithmParameters : public Managed{
    ...
    AlgorithmParameters():
        // algorithm          (0), // algorithm cost type     enum {PM_COST  = 0, CENSUS_TRANSFORM = 1, ADAPTIVE_CENSUS = 2, CENSUS_SELFSIMILARITY = 3, PM_SELFSIMILARITY = 4, ADCENSUS = 5, ADCENSUS_SELFSIMILARITY = 6, SPARSE_CENSUS = 7};
        ...
        n_best             (2), // CUDA
        cost_comb          (1), // CUDA  enum { COMB_ALL = 0, COMB_BEST_N = 1, COMB_ANGLE = 2, COMB_GOOD = 3 };
        cost_choice        (1), //
    ...
    int min_angle_degree;// fuse
    int max_angle_degree;// fuse
    int number_consistent_input;//fuse
};
